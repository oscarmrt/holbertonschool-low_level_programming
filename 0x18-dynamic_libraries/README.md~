...
libholberton.a, holberton.h - Create the static library libholberton.a containing all the functions listed below: - If you haven’t coded all of the above functions create empty ones with the right prototype.
